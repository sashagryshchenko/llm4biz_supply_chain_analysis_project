### conveted from johns files ####
### by David E Brown 2024/03/19 ###
# %%
def getFileReq(file):
    import requests
    from urllib.parse import urlparse
    import os
    import EnvSettings as ev
    curdir = os.getcwd()
    print("Current working dir:  ",curdir)
    os.chdir('/Users/davidebrown/Google Drive/DEBSupplyChainRepository/llm4biz_supply_chain_analysis_project')
    openai_key = ev.set_key
...
def filesRefs():    
    ...
    # Vector Storage
    initdir = os.getcwd()
    print("pgm initial Current working dir:  ",initdir)
    print("do get storage")
    ...
    #see below
    try:
        storage_context = lindex.StorageContext.from_defaults(
            persist_dir="./storage/ev_vec_idx"
        )
        index = lindex.load_index_from_storage(storage_context)
