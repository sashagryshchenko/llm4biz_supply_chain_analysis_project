...
#https://stackoverflow.com/questions/37021799/alternatives-for-wget-giving-error-403-forbidden
!mkdir -p 'data/ev_energy_source/'

!wget https://www.energy.gov/sites/prod/files/2019/12/f70/fcto-sa-2018-transportation-fuel-cell-cost-analysis.pdf -O 'data/ev_energy_source/fcto-sa-2018-transportation-fuel-cell-cost-analysis.pdf'
!wget http://transportproblems.polsl.pl/pl/Archiwum/2020/zeszyt3/2020t15z3_13.pdf -O 'data/ev_energy_source/2020t15z3_13.pdf'
!wget --user-agent="Mozilla" https://www.mdpi.com/2071-1050/13/9/4872/pdf?version=1620813581 -O 'data/ev_energy_source/pdf?version=1620813581'
!wget https://c2e2.unepccc.org/wp-content/uploads/sites/3/2019/09/analysis-of-hydrogen-fuel-cell-and-battery.pdf -O 'data/ev_energy_source/analysis-of-hydrogen-fuel-cell-and-battery.pdf'
!wget https://iopscience.iop.org/article/10.1149/2.0211514jes/pdf -O 'data/ev_energy_source/pdf'
!wget https://www.energy.gov/eere/fuelcells/articles/fuel-cell-and-battery-electric-vehicles-compared -O 'data/ev_energy_source/fuel-cell-and-battery-electric-vehicles-compared'
!wget https://www.hydrogen.energy.gov/docs/hydrogenprogramlibraries/pdfs/review23/fc353_james_2023_o-pdf.pdf  -O 'data/ev_energy_source/fc353_james_2023_o-pdf.pdf'
!wget https://escholarship.org/content/qt1g89p8dn/qt1g89p8dn_noSplash_e15c9e67dd1aab914d70e37a56cb70da.pdf?t=rg5613 -O 'data/ev_energy_source/qt1g89p8dn_noSplash_e15c9e67dd1aab914d70e37a56cb70da.pdf?t=rg5613'
!wget --user-agent="Mozilla" https://www.researchgate.net/journal/Energy-Technology-2194-4296/publication/341918035_Hydrogen_Fuel_Cell_Vehicle_Development_in_China_An_Industry_Chain_Perspective/links/619d50f2d7d1af224b1fdd50/Hydrogen-Fuel-Cell-Vehicle-Development-in-China-An-Industry-Chain-Perspective.pdf -O 'data/ev_energy_source/Hydrogen-Fuel-Cell-Vehicle-Development-in-China-An-Industry-Chain-Perspective.pdf'
!wget --user-agent="Mozilla" https://www.mdpi.com/2032-6653/14/9/262/pdf?version=1695025567 -O 'data/ev_energy_source/pdf?version=1695025567'

!wget --user-agent="Mozilla" https://www.researchgate.net/profile/Philipp-Reims/publication/365267244_ScienceDirect_Fuel_cell_system_production_cost_modeling_and_analysis/links/636cbd1c431b1f53008755b5/ScienceDirect-Fuel-cell-system-production-cost-modeling-and-analysis.pdf -O 'data/ev_energy_source/pdfft?md5=178a0ab35b1a29a2992ded6bbfd32c6b&pid=1-s2.0-S2352484722022995-main.pdf'
!wget --user-agent="Mozilla" https://www.researchgate.net/profile/Assia-Chadly/publication/354393953_Economics_of_the_Li-ion_Batteries_and_Reversible_Fuel_Cells_as_Energy_Storage_Systems_when_Coupled_with_Dynamic_Electricity_Pricing_Schemes/links/648ad96c7fcc811dcdce5f89/Economics-of-the-Li-ion-Batteries-and-Reversible-Fuel-Cells-as-Energy-Storage-Systems-when-Coupled-with-Dynamic-Electricity-Pricing-Schemes.pdf -O 'data/ev_energy_source/pdfft?md5=a6ae75e573ed603fe2be61b809aadfeb&pid=1-s2.0-S0360544221021897-main.pdf'

!wget --user-agent="Mozilla" https://link.springer.com/content/pdf/10.1007/s10311-021-01322-8.pdf -O 'data/ev_energy_source/s10311-021-01322-8.pdf'
!wget https://hydrogencouncil.com/wp-content/uploads/2020/01/Path-to-Hydrogen-Competitiveness_Full-Study-1.pdf -O 'data/ev_energy_source/Path-to-Hydrogen-Competitiveness_Full-Study-1.pdf'
!wget https://www.ourenergypolicy.org/wp-content/uploads/2017/05/1-s2.0-S1364032117305580-main.pdf -O 'data/ev_energy_source/1-s2.0-S1364032117305580-main.pdf'
!wget https://dspace.mit.edu/bitstream/handle/1721.1/104912/11367_2015_Article_986.pdf?sequence=1&isAllowed=y -O 'data/ev_energy_source/11367_2015_Article_986.pdf?sequence=1&isAllowed=y'
!wget https://iopscience.iop.org/article/10.1088/1748-9326/aae9b1/pdf -O 'data/ev_energy_source/pdf'
!wget https://wikirate.s3.amazonaws.com/files/784785/12677380.pdf -O 'data/ev_energy_source/12677380.pdf'
!wget --user-agent="Mozilla" https://www.mdpi.com/2076-3417/9/11/2296/pdf?version=1559636127 -O 'data/ev_energy_source/pdf?version=1559636127'
!wget https://www.doitpoms.ac.uk/tlplib/fuel-cells/printall.php -O 'data/ev_energy_source/printall.php'
...
if not index_loaded:
    # load data
    reader = SimpleDirectoryReader("./data/ev_energy_source/")
